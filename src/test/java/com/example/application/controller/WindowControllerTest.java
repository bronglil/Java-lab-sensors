...
class WindowControllerTest {
    ...
    void shouldFindAllWindows() throws Exception {
        Mockito.when(windowService.findAll()).thenReturn(List.of(
                new Window(1L, "Window 1", WindowStatus.OPEN, 1L),
    ...
    void shouldCreateWindow() throws Exception {
        Window windowDto = new Window(null, "Window 1", WindowStatus.OPEN, 1L);
        Window savedWindow = new Window(1L, "Window 1", WindowStatus.OPEN, 1L);
